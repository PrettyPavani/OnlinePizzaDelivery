...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['createCategory'])) {
        ...
        $sql = "INSERT INTO `categories` (`name`, `desc`, `createdate`) VALUES ('$name', '$desc', current_timestamp())";   
    ...
    if(isset($_POST['removeCategory'])) {
        $catId = $_POST["catId"];
        $filename = $_SERVER['DOCUMENT_ROOT']."/OnlinePizzaDelivery/src/controller/users/assets/img/card-".$catId.".jpg";
    ...
    if(isset($_POST['updateCategory'])) {
        ...
        $sql = "UPDATE `categories` SET `name`='$catName', `desc`='$catDesc' WHERE `id`='$catId'";   
        $result = mysqli_query($conn, $sql);
        if ($result){
