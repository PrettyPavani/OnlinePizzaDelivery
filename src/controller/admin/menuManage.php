<div class="container-fluid" style="margin-top:98px">
	...
	<div class="col-lg-12">
		<div class="row">
			<!-- FORM Panel -->
			<div class="col-md-4">
			<form action="templates/menuManage.php" method="post" enctype="multipart/form-data">
				<div class="card mb-3">
						...
						<table class="table table-bordered table-hover mb-0">
                            ...
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo '<tr>
                                            <td class="text-center">' .$categorie_id. '</td>
                                            <td>
                                                <img src="/OnlinePizzaDelivery/src/controller/users/assets/img/pizza-'.$pizzaId. '.jpg" alt="image for this item" width="150px" height="150px">
                                            </td>
                                            <td>
                                                <p>Name : <b>' .$name. '</b></p>
                                            ...
                                            <td class="text-center">
												<div class="row mx-auto" style="width:112px">
													...
													<form action="templates/menuManage.php" method="POST">
...
<?php 
    ...
    while($pizzaRow = mysqli_fetch_assoc($pizzaResult)){
        ...
        $categorie_id = $pizzaRow['categorie_id'];
        $desc = $pizzaRow['desc'];
?>
	  	...
	  	<form action="templates/menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
				...
				<div class="form-group col-md-4">
					<img src="/OnlinePizzaDelivery/src/controller/users/assets/img/pizza-<?php echo $pizzaId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="item image" width="100" height="100">
				</div>
			</div>
		</form>
		<form action="templates/menuManage.php" method="post">
			...
			<div class="text-left my-2 row">
				...
				<div class="form-group col-md-6">
                	...
                	<input class="form-control" id="catId" name="catId" value="<?php echo $categorie_id; ?>" type="number" min="1" required>
				</div>
            </div>
            <div class="text-left my-2">
