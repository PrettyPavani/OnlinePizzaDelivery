                    ...
                    <tbody>
                        <?php
                            ...
                            while($row=mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                    <td>' .$id. '</td>
                                    <td><img src="/OnlinePizzaDelivery/src/controller/users/assets/img/person-' .$id. '.jpg" alt="image for this user" onError="this.src =\'/OnlinePizzaDelivery/src/controller/users/assets/img/profilePic.jpg\'" width="100px" height="100px"></td>
                                    <td>' .$username. '</td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <div class="row mx-auto" style="width:112px">
                                            ...
                                            if($id == 1) {
                                                ...
                                                echo '<form action="templates/userManage.php" method="POST">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="templates/userManage.php" method="post">
        ...
        <div class="modal-body">
            ...
            <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                <div class="form-group col-md-8">
                    <form action="templates/userManage.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-4">
                    <img src="/OnlinePizzaDelivery/src/controller/users/assets/img/person-<?php echo $id; ?>.jpg" alt="Profile Photo" width="100" height="100" onError="this.src ='/OnlinePizzaDelivery/src/controller/users/assets/img/profilePic.jpg'">
                    <form action="templates/userManage.php" method="post">
                        <input type="hidden" id="user_id" name="user_id" value="<?php echo $id; ?>">
