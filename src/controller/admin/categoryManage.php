<div class="container-fluid" style="margin-top:98px">
    <div class="col-lg-12">
        <div class="row">
            <!-- FORM Panel -->
            <div class="col-md-4">
                <form action="templates/categoryManage.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        ...
                        <?php 
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                echo '<tr>
                                        ...
                                        <td><img src="/OnlinePizzaDelivery/src/controller/users/assets/img/card-'.$catId. '.jpg" alt="image for this Category" width="150px" height="150px"></td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="templates/categoryManage.php" method="POST">
        ...
        <form action="templates/categoryManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
				...
				<div class="form-group col-md-4">
					<img src="/OnlinePizzaDelivery/src/controller/users/assets/img/card-<?php echo $catId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="Category image" width="100" height="100">
				</div>
			</div>
		</form>
        <form action="templates/categoryManage.php" method="post">
