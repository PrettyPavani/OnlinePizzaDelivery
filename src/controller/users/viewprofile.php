...
<head>
    ...
    <title>Profile </title>
    <link rel = "icon" href ="/OnlinePizzaDelivery/src/controller/users/assets/img/logo.jpg" type = "image/x-icon">
    ...
    <style>
        ...
        background: url('/OnlinePizzaDelivery/src/controller/users/assets/img/bg.jpg') no-repeat;
...
<body>
    <?php include 'templates/dbconnect.php';?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="jumbotron p-3 mb-3" style="display: flex;justify-content: center;width: 28%;border-radius: 50px;margin: 0 auto;">
                <div class="user-info">
                    <img class="rounded-circle mb-3 bg-dark" src="/OnlinePizzaDelivery/src/controller/users/assets/img/person-<?php echo $user_id; ?>.jpg" onError="this.src = '/OnlinePizzaDelivery/src/controller/users/assets/img/profilePic.jpg'" style="width:215px;height:215px;padding:1px;">
                    <form action="templates/manageprofile.php" method="POST">
                        <button type="submit" class="btn btn-primary" name="removeProfilePic" style="font-size: 12px;padding: 3px 8px;border-radius: 9px;">Remove Image</button>
                    </form>
                    <form action="templates/manageprofile.php" method="POST" enctype="multipart/form-data" style="margin-top: 7px;">
                    ...
                    <ul class="meta list list-unstyled" style="text-align:center;">
                        ...
                        <li class="my-2"><a href="templates/logout.php"><button class="btn btn-secondary" style="font-size: 15px;padding: 3px 8px;">Logout</button></a></li>
                    </ul>
                </div>
            </div>
