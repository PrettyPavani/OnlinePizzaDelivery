<!doctype html>
  ...
  <?php include 'templates/navigation.php';?>
      <div class="contact2" style="background-image:url(/OnlinePizzaDelivery/src/controller/users/assets/img/map.jpg);height: 400px;" id="contact">
        <div class="container">
                ...
                <div class="row">
                  <div class="col-lg-8">
                    <div class="contact-box p-4">
                      ...
                      <?php
                          $passSql = "SELECT * FROM users WHERE id='$id'"; 
                          $passResult = mysqli_query($conn, $passSql);
                          $passRow=mysqli_fetch_assoc($passResult);
                          $email = $passRow['email'];
                          $phone = $passRow['phone'];                          
                      ?>
                      <form action="templates/managecontactus.php" method="POST">
                        <div class="row">
                          <div class="col-lg-6">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                              ...
                              <small id="order_idHelp" class="form-text text-muted">If your problem is not related to the order(order id = 0).</small>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                  ...
                  <?php
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background-image:url(/OnlinePizzaDelivery/src/controller/users/assets/img/contact.jpg)">
