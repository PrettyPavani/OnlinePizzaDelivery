...
<body>
    ...
    <div class="container my-4" id="cont">
        ...
        echo  '<div class="col-md-4">
                <img src="/OnlinePizzaDelivery/src/controller/users/assets/img/pizza-'.$pizzaId. '.jpg" width="249px" height="262px">
            </div>
            <div class="col-md-8 my-4">
                ...
                if($loggedin){
                    $quaSql = "SELECT `quantity` FROM `viewcart` WHERE pizzaId = '$pizzaId' AND `user_id`='$user_d'";
                ...
                <div class="mx-4">
                    <a href="viewpizzalist.php?catid=' . $categorie_id . '" class="active text-dark">
