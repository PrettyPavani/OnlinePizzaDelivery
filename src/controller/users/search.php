...
<head>
    ...
    <title>Home</title>
    <link rel = "icon" href ="/OnlinePizzaDelivery/src/controller/user/assets/img/logo.jpg" >
    <style>
    #cont {
        min-height : 515px;
    }
...
<body>
    ...
    <div class="container my-3">
        ...
        <?php 
            $noResult = true;
            $query = $_GET["search"];
            $sql = "SELECT * FROM `categories` WHERE MATCH(`name`, `desc`) against('$query')"; 
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        <img src="/OnlinePizzaDelivery/src/controller/users/assets/img/card-'.$catId. '.jpg" class="card-img-top" alt="image for this pizza" width="249px" height="270px">
                        <div class="card-body">
    ...
    <div class="container my-3" id="cont">
        ...
        <?php 
            $query = $_GET["search"];
            $sql = "SELECT * FROM `pizza` WHERE MATCH('name', `desc`) against('$query')"; 
            $result = mysqli_query($conn, $sql);
            while($row = mysqli_fetch_assoc($result)){
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">';
                                if($loggedin){
                                    $quaSql = "SELECT `quantity` FROM `viewcart` WHERE pizzaId = '$pizzaId' AND `user_id`='$user_id'";
                                    $quaresult = mysqli_query($conn, $quaSql);
                                    $quaExistRows = mysqli_num_rows($quaresult);
                                    if($quaExistRows == 0) {
                                        echo '<form action="templates/managecart.php" method="POST">
