<?php 
    ...
    echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
              ...
              while($row = mysqli_fetch_assoc($result)){
                echo '<a class="dropdown-item" href="viewpizzalist.php?catid=' .$row['id']. '">' .$row['name']. '</a>';
              }
              echo '</div>
          </li>
          <li class="nav-item">
        ...
        <form method="get" action="/OnlinePizzaDelivery/src/controller/users/search.php" class="form-inline my-2 my-lg-0 mx-3">
        ...
        $countsql = "SELECT SUM(`quantity`) FROM `viewcart` WHERE `user_id`=$user_id"; 
        ...
        echo '<a href="viewcart.php"><button type="button" class="btn btn-secondary mx-2" title="MyCart">
          <svg xmlns="/OnlinePizzaDelivery/src/controller/users/assets/img/cart.svg" width="16" height="16" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
        ...
        if($loggedin){
          ...
          <div class="text-center image-size-small position-relative">
            <a href="viewprofile.php"><img src="/OnlinePizzaDelivery/src/controller/users/assets/img/person-' .$user_id. '.jpg" class="rounded-circle" onError="this.src = \'/OnlinePizzaDelivery/src/controller/users/assets/img/profilePic.jpg\'" style="width:40px; height:40px"></a>
          </div>';
        }else {
          echo '
      ...
      include 'templates/signupmodal.php';
